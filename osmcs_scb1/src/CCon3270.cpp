...
void CCon3270::Start(string l, unsigned timeout) {
	...
	//char c[300]="/usr/bin/x3270 -script -model 2 -proxy socks5:socks.lsb.esni.ibm.com:1080 192.168.90.17";
	fpipe = exp_popen(c);
...
void CCon3270::Start(string l) {
	...
	#else
			proxy += "-cafile /home/MarlonSimoni/certificados/CERT.SUBCAMTP.pem -noverifycert 10.200.101.20:992";
	#endif
		} else if (lpar == "MG1P") {
	#ifdef YYIBM01
			proxy += "-cafile /home/cgdibm02/certificados/CERT.SUBCAMTP.pem -noverifycert 10.200.101.30:992";
	#else
			proxy += "-cafile /home/MarlonSimoni/certificados/CERT.SUBCAMTP.pem -noverifycert 10.200.101.30:992";
	#endif
		} else if (lpar == "MG1C") {
			proxy += "10.200.101.50";
		} else if (lpar == "MG1T") {
	...
	#else
			proxy += "-cafile /home/MarlonSimoni/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.17:992";
	#endif
		} else if (lpar == "SYB1") {
	#ifdef YYIBM01
			proxy += "-cafile /home/cgdibm02/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.17:992";
	...
	#else
			proxy += "-cafile /home/MarlonSimoni/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.73:992";
	#endif
		} else if (lpar == "MCFB") {
	#ifdef YYIBM01
			proxy += "-cafile /home/cgdibm02/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.81:992";
	#else
			proxy += "-cafile /home/MarlonSimoni/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.81:992";
	#endif
		} else if (lpar == "MVS2") {
	#ifdef YYIBM01
			proxy += "-cafile /home/cgdibm02/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.161:992";
	#else
			proxy += "-cafile /home/MarlonSimoni/certificados/GrupoCGDRootCA.pem -noverifycert 192.168.90.161:992";
	#endif
		}
	//proxy = proxy.c_str();
	//char c[200] = PROXY;
